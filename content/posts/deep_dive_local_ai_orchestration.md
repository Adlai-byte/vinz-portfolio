---
title: "A Deep Dive into Local AI Orchestration"
slug: "deep_dive_local_ai_orchestration"
excerpt: "As universities increasingly adopt AI to streamline student services, the immediate challenge is often data privacy and cost. This project is a Retrieval-Augmented Generation (RAG) agent that runs entirely on local hardware."
type: "blog"
tags: ["AI", "Ollama", "LangChain", "Streamlit", "RAG"]
published: true
date: "2026-03-11"
---
...
**Hybrid Ensemble Retriever** — Combining dense and sparse search:
```python
# rag_engine.py
